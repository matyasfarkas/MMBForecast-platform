...
ModelOutput.Mean.xgdp_a_obs = [oo_.SmoothedVariables.Mean.xgdp_q_obs(end); oo_.PointForecast.Mean.xgdp_q_obs(1:basics.forecasthorizon)]*4;
ModelOutput.Mean.pgdp_a_obs = [oo_.SmoothedVariables.Mean.pgdp_q_obs(end); oo_.PointForecast.Mean.pgdp_q_obs(1:basics.forecasthorizon)]*4;
ModelOutput.Mean.rff_a_obs  = [oo_.SmoothedVariables.Mean.rff_q_obs(end); oo_.PointForecast.Mean.rff_q_obs(1:basics.forecasthorizon)]*4;

ModelOutput.Median.xgdp_a_obs = [oo_.SmoothedVariables.Median.xgdp_q_obs(end); oo_.PointForecast.Median.xgdp_q_obs(1:basics.forecasthorizon)]*4;
ModelOutput.Median.pgdp_a_obs = [oo_.SmoothedVariables.Median.pgdp_q_obs(end); oo_.PointForecast.Median.pgdp_q_obs(1:basics.forecasthorizon)]*4;
ModelOutput.Median.rff_a_obs  = [oo_.SmoothedVariables.Median.rff_q_obs(end); oo_.PointForecast.Median.rff_q_obs(1:basics.forecasthorizon)]*4;

ModelOutput.Distribution.xgdp_a_obs = [oo_.SmoothedVariables.deciles.xgdp_q_obs(:,end), oo_.PointForecast.deciles.xgdp_q_obs(:,1:basics.forecasthorizon)]*4;
ModelOutput.Distribution.pgdp_a_obs = [oo_.SmoothedVariables.deciles.pgdp_q_obs(:,end), oo_.PointForecast.deciles.pgdp_q_obs(:,1:basics.forecasthorizon)]*4;
ModelOutput.Distribution.rff_a_obs  = [oo_.SmoothedVariables.deciles.rff_q_obs(:,end), oo_.PointForecast.deciles.rff_q_obs(:,1:basics.forecasthorizon)]*4;

ModelOutput.HPDinf.xgdp_a_obs = [oo_.SmoothedVariables.HPDinf.xgdp_q_obs(end); oo_.PointForecast.HPDinf.xgdp_q_obs(1:basics.forecasthorizon)]*4; 
ModelOutput.HPDinf.pgdp_a_obs = [oo_.SmoothedVariables.HPDinf.pgdp_q_obs(end); oo_.PointForecast.HPDinf.pgdp_q_obs(1:basics.forecasthorizon)]*4;
ModelOutput.HPDinf.rff_a_obs  = [oo_.SmoothedVariables.HPDinf.rff_q_obs(end); oo_.PointForecast.HPDinf.rff_q_obs(1:basics.forecasthorizon)]*4;

ModelOutput.HPDsup.xgdp_a_obs = [oo_.SmoothedVariables.HPDsup.xgdp_q_obs(end); oo_.PointForecast.HPDsup.xgdp_q_obs(1:basics.forecasthorizon)]*4;
ModelOutput.HPDsup.pgdp_a_obs = [oo_.SmoothedVariables.HPDsup.pgdp_q_obs(end); oo_.PointForecast.HPDsup.pgdp_q_obs(1:basics.forecasthorizon)]*4;
ModelOutput.HPDsup.rff_a_obs  = [oo_.SmoothedVariables.HPDsup.rff_q_obs(end); oo_.PointForecast.HPDsup.rff_q_obs(1:basics.forecasthorizon)]*4;
